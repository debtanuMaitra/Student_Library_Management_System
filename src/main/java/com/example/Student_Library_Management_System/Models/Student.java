...
public class Student {
    ...
    //Name of variable of the Parent Entity that you have written in child class foreign key attribute (for the mapped by section)
    ...
    *
    * 1. Go to the child class (In this case --> Card)
    ...
    * )
    * 3. Choose the variable name of the parent Entity (reference: studentVariableName)
    *  */
